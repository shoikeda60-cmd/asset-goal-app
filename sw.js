const CACHE='asset-goal-v13-delete-sync';
...
function enhanceHtml(html){
  const scripts=[];
  if(!html.includes('cashflow.js')) scripts.push('<script src="./cashflow.js?v=13"></script>');
  if(!html.includes('delete-sync.js')) scripts.push('<script src="./delete-sync.js?v=13"></script>');
  if(!html.includes('chart-axis.js')) scripts.push('<script src="./chart-axis.js?v=13"></script>');
  if(!html.includes('rate-tab.js')) scripts.push('<script src="./rate-tab.js?v=13"></script>');
  if(!html.includes('rate-sbi.js')) scripts.push('<script src="./rate-sbi.js?v=13"></script>');
